========================================================================
     Microsoft Foundation Class Library for Windows CE: DWars
========================================================================


AppWizard has created this DWars application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your DWars application.

DWars.h
    This is the main header file for the application.  It includes other
    project specific headers (including Resource.h) and declares the
    CDWarsApp application class.
...
res\DWars.ico
    ...
    icon is included by the main resource file DWars.rc.
...
DWarsDoc.h, DWarsDoc.cpp - the document
    These files contain your CDWarsDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CDWarsDoc::Serialize).

DWarsView.h, DWarsView.cpp - the view of the document
    These files contain your CDWarsView class.
    CDWarsView objects are used to view CDWarsDoc objects.
...
StdAfx.h, StdAfx.cpp
    ...
    named DWars.pch and a precompiled types file named StdAfx.obj.
